  ...
  return (
    <section className="bg-white py-20 md:py-28">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <button
                  ...
                  className="
                    ...
                    focus-visible:ring-2 focus-visible:ring-brand-cyan focus-visible:ring-inset
                  "
                ...
                >
                  ...
                  <div className={`
                    ...
                    ${isOpen
                      ? "bg-brand-cyan/15 border-brand-cyan/30 rotate-45"
                      : "bg-slate-50 border-slate-200"
                    }
                  `}>
                    <svg
                      className={`w-3.5 h-3.5 ${isOpen ? "text-brand-teal" : "text-brand-gray"}`}
        ...
        <div className="mt-10 text-center p-6 rounded-2xl bg-brand-light border border-brand-navy/8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="tel:3237818600"
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold border border-brand-navy/15 text-brand-navy hover:bg-white transition-colors duration-200"
            >
              (323) 781-8600
            </a>
            <a
              href="mailto:steve@adaptiveautomate.com"
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold bg-brand-navy text-brand-cyan hover:bg-brand-navy/90 transition-colors duration-200"
            >
              Email Adaptive AI
            </a>
          </div>
